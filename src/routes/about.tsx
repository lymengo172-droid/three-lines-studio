    ...
    <Shell>
      <div className="mx-auto max-w-3xl px-5 pt-12 sm:pt-20">
        ...
        <div className="mt-8 space-y-5 text-base leading-relaxed text-foreground/90">
          <p>{t("Kiri Studio is a custom-print studio in Phnom Penh. We run three product lines under one roof: acrylic objects, ultra-HD metal wall art, and custom merch.", "Kiri Studio ជាស្ទូឌីយោបោះពុម្ពតាមតម្រូវនៅភ្នំពេញ។", lang)}</p>
